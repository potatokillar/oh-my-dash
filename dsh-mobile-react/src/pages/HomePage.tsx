...
export default function HomePage() {
  ...
  const { data: projectList, isLoading: loadingProjects } =
    trpc.sessions.projects.useQuery({ deviceId }, { refetchInterval: 8000 });
  const { data: sessionList, isLoading: loadingSessions } = trpc.sessions.list.useQuery(
    { deviceId },
  ...
  return (
    <PhoneShell>
      ...
      >
        ...
        {/* ---------- 项目视图 ---------- */}
        <TabsContent value="projects" className="mt-0 flex min-h-0 flex-1 flex-col">
